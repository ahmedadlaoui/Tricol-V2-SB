...
public class PurchaseOrderController implements PurchaseOrderControllerInterface {
    ...
    @Override
    public ResponseEntity<ReadPurchaseOrderDTO> createPurchaseOrder(@Valid CreatePurchaseOrderDTO createPurchaseOrderDTO) {
    ...
    @Override
    public ResponseEntity<ReadPurchaseOrderDTO> updatePurchaseOrder(Long id, @Valid UpdatePurchaseOrderDTO updatePurchaseOrderDTO) {
        ReadPurchaseOrderDTO updatedPurchaseOrder = purchaseOrderService.updatePurchaseOrder(id, updatePurchaseOrderDTO);
